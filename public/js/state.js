...
const state = {
  ...
  controlImages: { segmentation: null, edge: null },  // For LoRA preview (1024x1024)
...
const DEFAULT_WORLD_SEED = {
  ...
  pois: [
    // === TERRAIN ZONES ===
    // Note: These are regional hints, not strict requirements
    // The UI sliders (forest density, water level) control global terrain balance
    {
      id: "whispering_woods",
      type: "forest",
      name: "Whispering Woods",
      region: { x_min: 0, x_max: 12, y_min: 0, y_max: 10 },
      density: 0.4,  // Reduced - let slider control forest amount
    ...
    },
    {
      ...
      density: 0.5,  // Moderate water concentration
    ...
    },
    {
      ...
      density: 0.7,  // Increased - make plains more prominent
...
// TileTypes for rendering - uses WFC.TILES (loaded from Tile.js before this file)
// Note: Tile.js must be loaded before state.js in index.html
