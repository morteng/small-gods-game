 ...
 *   down  10 tracks · max     71° · step    23° (armL_up) · loop 4° · 0 plant(s) · in-plane ≥ 0.77 (armL_up)
 *   up    10 tracks · max     71° · step    23° (armR_up) · loop 4° · 0 plant(s) · in-plane ≥ 0.77 (armR_up)
...
export const CLIP_WAVE_DOWN: Clip = {
  ...
  tracks: {
    ...
    armL_fore: [
      { t: 0, deg: 0, dx: 0, dy: 0 },
      { t: 0.0625, deg: -21, dx: 0, dy: 1 },
      { t: 0.125, deg: -67, dx: 1, dy: 2.75 },
      { t: 0.15625, deg: -62, dx: 1.5, dy: 2.5 },
      { t: 0.1875, deg: -71, dx: 1, dy: 2.75 },
      { t: 0.25, deg: -65, dx: 1.25, dy: 2.75 },
      { t: 0.28125, deg: -68, dx: 0.75, dy: 2.75 },
      { t: 0.34375, deg: -63, dx: 1, dy: 2.75 },
      { t: 0.375, deg: -66.5, dx: 0.75, dy: 3 },
      { t: 0.40625, deg: -65, dx: 0.75, dy: 3 },
      { t: 0.4375, deg: -58.5, dx: 1, dy: 2.75 },
      { t: 0.5, deg: -62, dx: 0.75, dy: 3 },
      { t: 0.5625, deg: -55, dx: 0.75, dy: 3 },
      { t: 0.59375, deg: -64, dx: 0.75, dy: 3 },
      { t: 0.625, deg: -56, dx: 1, dy: 2.75 },
      { t: 0.65625, deg: -52.5, dx: 0.75, dy: 3 },
      { t: 0.6875, deg: -60, dx: 0.75, dy: 3 },
      { t: 0.75, deg: -49.5, dx: 0.75, dy: 3 },
      { t: 0.78125, deg: -35, dx: 0, dy: 2.5 },
      { t: 0.84375, deg: -4.5, dx: -0.25, dy: 0.5 },
      { t: 0.9375, deg: 6.5, dx: 0.25, dy: -0.5 },
      { t: 1, deg: 4, dx: 0, dy: -0.25 },
    ],
    armR_up: [
      { t: 0, deg: 0, dx: 0, dy: 0 },
    ...
    armR_fore: [
      { t: 0, deg: 0, dx: 0, dy: 0 },
      { t: 0.125, deg: -6.5, dx: -0.25, dy: -0.25 },
      { t: 0.21875, deg: -4.5, dx: -0.25, dy: -0.25 },
      { t: 0.46875, deg: -5, dx: -0.25, dy: -0.25 },
      { t: 0.625, deg: -9, dx: -0.25, dy: -0.5 },
      { t: 0.78125, deg: -8, dx: -0.25, dy: -0.5 },
      { t: 0.90625, deg: 2, dx: 0, dy: 0.25 },
      { t: 1, deg: 1.5, dx: 0, dy: 0.25 },
    ],
    legL_up: [
      { t: 0, deg: 0, dx: 0, dy: 0 },
...
export const CLIP_WAVE_UP: Clip = {
  ...
  tracks: {
    ...
    armL_fore: [
      { t: 0, deg: 0, dx: 0, dy: 0 },
      { t: 0.125, deg: 6.5, dx: 0.25, dy: -0.5 },
      { t: 0.21875, deg: 4.5, dx: 0.25, dy: -0.25 },
      { t: 0.46875, deg: 5, dx: 0.25, dy: -0.5 },
      { t: 0.625, deg: 9, dx: 0.25, dy: -0.75 },
      { t: 0.78125, deg: 8, dx: 0.25, dy: -0.75 },
      { t: 0.90625, deg: -2, dx: 0, dy: 0.25 },
      { t: 1, deg: -1.5, dx: 0, dy: 0.25 },
    ],
    armR_up: [
    ...
    armR_fore: [
      { t: 0, deg: 0, dx: 0, dy: 0 },
      { t: 0.0625, deg: 21, dx: 0.25, dy: 0.25 },
      { t: 0.125, deg: 67, dx: -0.25, dy: 2.25 },
      { t: 0.15625, deg: 62, dx: -0.5, dy: 0.75 },
      { t: 0.1875, deg: 71, dx: -0.25, dy: 2.5 },
      { t: 0.25, deg: 65, dx: -0.25, dy: 1.75 },
      { t: 0.28125, deg: 68, dx: 0, dy: 2.5 },
      { t: 0.34375, deg: 63, dx: -0.25, dy: 1.75 },
      { t: 0.375, deg: 66.5, dx: 0, dy: 2.5 },
      { t: 0.40625, deg: 65, dx: 0, dy: 2.5 },
      { t: 0.4375, deg: 58.5, dx: 0, dy: 1.5 },
      { t: 0.46875, deg: 62, dx: 0, dy: 2.5 },
      { t: 0.5, deg: 62, dx: 0, dy: 2.5 },
      { t: 0.5625, deg: 55, dx: 0, dy: 1.75 },
      { t: 0.59375, deg: 64, dx: 0, dy: 2.5 },
      { t: 0.625, deg: 56, dx: 0, dy: 1.5 },
      { t: 0.65625, deg: 52.5, dx: 0, dy: 1.5 },
      { t: 0.6875, deg: 60, dx: 0, dy: 2.25 },
      { t: 0.75, deg: 49.5, dx: 0, dy: 1.25 },
      { t: 0.78125, deg: 35, dx: 0.5, dy: 1.5 },
      { t: 0.84375, deg: 4.5, dx: 0.25, dy: 0.25 },
      { t: 0.9375, deg: -6.5, dx: -0.25, dy: -0.25 },
      { t: 1, deg: -4, dx: 0, dy: -0.25 },
    ],
    legL_up: [
      { t: 0, deg: 0, dx: 0, dy: 0 },
