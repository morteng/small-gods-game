...
import { towerPartType, porchPartType, chimneyPartType, waterwheelPartType } from './parts/structural';
import { furnacePartType } from './parts/furnace';
...
import { seaArchPartType, cliffFacePartType, caveMouthPartType, hoodooPartType } from './parts/landform';
import { stairFlightPartType, landingPartType } from './parts/stair';
import { deckPartType, pierPartType, archSpanPartType, abutmentPartType, logPartType } from './parts/bridge';
...
export function ensureBuildingTypesRegistered(): void {
  ...
  for (const pt of [bodyPartType, wingPartType, towerPartType, porchPartType, chimneyPartType, waterwheelPartType, furnacePartType, primPartType, wellPartType, graveyardPartType, stallPartType, tentPartType, branchPlantPartType, rockPartType, stairFlightPartType, landingPartType, deckPartType, pierPartType, archSpanPartType, abutmentPartType, logPartType, columnPartType, railingPartType, channelPartType, barrierPartType, seaArchPartType, cliffFacePartType, caveMouthPartType, hoodooPartType]) registerPartType(pt);
