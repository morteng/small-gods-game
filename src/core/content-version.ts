 ...
 */
export const WORLD_CONTENT_VERSION = 26;  // DIAGONAL BRIDGES: a river crossing's deck + arches now span as ONE straight slab at the TRUE bank→bank bearing (diagonal fords get diagonal bridges that seat on their banks) instead of snapping to a cardinal stub, and pier/arch height tracks the real bank-to-bed clearance — crossing-structure entities change ⇒ discard older autosaves. (25 = riverside levee #24; 24 = parallel-road merge; 23 = entrance stoops; 22 = river density area-scaling; 21 = aqueduct arcade G6 polish; 20 = emergent aqueducts G6 on piers; 19 = stairs CONNECT G3d.)
