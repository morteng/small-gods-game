 ...
 */
export const WORLD_CONTENT_VERSION = 27;  // SPATIAL-COORDINATION C1: croft/settlement barrier gates now open over a building's VISUAL extent (the renderer's structure box) instead of just its solid wall cells, so no hedge/fence/wall slab peeks out from under a door threshold or draw-only part cell — barrier gate spans change ⇒ discard older autosaves. (26 = diagonal bridges; 25 = riverside levee #24; 24 = parallel-road merge; 23 = entrance stoops; 22 = river density area-scaling; 21 = aqueduct arcade G6 polish; 20 = emergent aqueducts G6 on piers; 19 = stairs CONNECT G3d.)
