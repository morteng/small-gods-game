 ...
 */
export const WORLD_CONTENT_VERSION = 29;  // SITE EXPANSION (E2): a placed establishment is expanded through the site connectome (expandSite → siteToPlan) and the auxiliary buildings its function derives are co-placed in the adjacent yard — a tavern now spawns a 'stable' (from its 'stabling' requirement) on free ground beside it. Additive (the main layout is byte-identical; only outbuildings are appended) but worldgen output gains entities ⇒ discard older autosaves. (28 = site-fitness live-wiring; 27 = barrier gates over visual extent C1; 26 = diagonal bridges; 25 = riverside levee #24; 24 = parallel-road merge; 23 = entrance stoops; 22 = river density area-scaling; 21 = aqueduct arcade G6 polish; 20 = emergent aqueducts G6 on piers; 19 = stairs CONNECT G3d.)
