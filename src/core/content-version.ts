 ...
 */
export const WORLD_CONTENT_VERSION = 64;  // LANDMARK KEEP-OUT: coastal/highland landmark props (arch/cliff-face/cave/hoodoo) now keep a 22-tile clearance from settlement seats (`buildCoastalLandmarks` takes settlement centres; `SETTLEMENT_TYPES` = village/city/castle/port/farm/…), so a hoodoo or cave no longer sprouts in the middle of a town. Placement changes ⇒ discard older autosaves. See prior notes below.
