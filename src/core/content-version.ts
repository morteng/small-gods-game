 ...
 */
export const WORLD_CONTENT_VERSION = 52;  // TOWN-WALL THICKNESS: stone town curtain 4 m→2 m (thicknessTiles 2→1) — a typical medieval town wall, not Constantinople-grade. Tall+thin reads as a proper wall; the earthen rampart stays broad. Barrier footprint/foundation carve changes ⇒ discard older autosaves. See prior notes below.
